package com.multichat.getuserservice.getuserservice.Controllers;
...
import com.multichat.getuserservice.getuserservice.Repos.ChatRepository;
import com.multichat.getuserservice.getuserservice.Repos.UserRepository;
...
public class UserController {
  ...
  public ResponseEntity<String> addChat(@RequestBody List<String> users) throws Exception {
    try {
      ...
      return ResponseEntity.status(200).body("chat " + chatID + " added to users " + users.toString());
    } catch (Exception e) {
      e.printStackTrace();
